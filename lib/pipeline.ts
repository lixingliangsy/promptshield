...
export const PIPELINE_ID = 'promptshield-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · App description & sample input",
  process: "Step 2/3 · Scan injection & jailbreak patterns",
  output: "Step 3/3 · Risk report + hardening checklist",
}
