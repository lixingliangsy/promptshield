    ...
    <Layout>
      ...
      <div className="max-w-3xl">
        ...
        <p className="text-lg text-slate-600 mb-10">
          PromptShield processes the inputs you submit for analysis. This page states, plainly, what we handle and what we do not claim.
        </p>

        <Sec title="What we handle">
          <p>AI app descriptions and optional sample untrusted user inputs for injection scanning.</p>
        </Sec>
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 mb-10 text-sm text-amber-900">
          <strong>Honesty rule:</strong> PromptShield is a scanner and decision-support tool. We do not guarantee detection of every injection, 100% jailbreak coverage, or that you will never miss a bypass. We do <strong>not</strong> claim guarantee / 100% / never miss.
        </div>

        <Sec title="Our compliance posture">
          <ul className="list-disc pl-5 space-y-1">
            <li>PromptShield is <strong>decision-support</strong>, not a law firm, clinic, or certified auditor.</li>
        ...
        <p className="text-xs text-slate-400 mt-8">
          refs: OWASP LLM01 Prompt Injection · OWASP Top 10 for LLM Applications · NIST AI RMF
        </p>
      </div>
    </Layout>
  )
