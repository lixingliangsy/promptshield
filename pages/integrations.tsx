...
const rows = [
  { title: "CSV/JSON export", body: "Pro exports via /api/runs." },
  { title: "CI gate (Pro)", body: "Wire scans into pipelines when enabled." },
  { title: "API", body: "Programmatic scans for app fleets." },
  { title: "BYOK", body: "Enterprise keys stay server-side." },
]
    ...
    <Layout>
      ...
      <div className="max-w-4xl">
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 mt-6 text-sm text-amber-900">
          <strong>Honesty note:</strong> CI depth depends on plan. We do not invent shipped connectors.
        </div>
      </div>
    </Layout>
  )
