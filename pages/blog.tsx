...
const howToSteps = [
  { name: 'Describe the AI app', text: 'Summarize how your product uses prompts and where untrusted user input enters.' },
  { name: 'Paste sample inputs', text: 'Add representative untrusted inputs that attackers or power users might try.' },
  { name: 'Review the hardening checklist', text: 'Turn fired patterns into tickets; remediate before you ship.' },
]
...
export default function Page() {
  ...
  const SHORT = "PromptShield scans an AI app for prompt-injection and jailbreak risk before you ship."
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">PromptShield scans an AI app for prompt-injection and jailbreak risk before you ship.</p>
