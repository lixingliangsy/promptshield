...
const steps = [
  { n: "1", t: "Describe", d: "Describe your AI app and optionally paste untrusted sample input." },
  { n: "2", t: "Scan", d: "Deterministic injection patterns run; risk is rated with concrete hits." },
  { n: "3", t: "Harden", d: "Apply the checklist; export for your security review." },
]
