  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://promptshield.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is PromptShield?", "acceptedAnswer": {"@type": "Answer", "text": "PromptShield scans AI apps for prompt-injection and jailbreak vulnerabilities before you ship."}}, {"@type": "Question", "name": "What do I paste in?", "acceptedAnswer": {"@type": "Answer", "text": "A short description of your AI app and samples of untrusted user input."}}, {"@type": "Question", "name": "What does the report include?", "acceptedAnswer": {"@type": "Answer", "text": "The patterns that fired plus a hardening checklist you can action."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "LLM/agent product teams — developers and security partners shipping user-facing prompts."}}, {"@type": "Question", "name": "Is it a penetration test?", "acceptedAnswer": {"@type": "Answer", "text": "No. It is a decision-support risk pass, not a formal pentest or compliance attestation."}}, {"@type": "Question", "name": "Does it guarantee a safe model?", "acceptedAnswer": {"@type": "Answer", "text": "No. It surfaces likely injection/jailbreak patterns; you still own remediation and review."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-xs font-bold tracking-widest uppercase text-teal-700 mb-3">What it is</div>
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">PromptShield - definition</h2>
        ...
        <section id="geo-faq" className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="space-y-6">
              {((PRODUCT as any).geoFaq || []).map((f: { q?: string; a?: string }, i: number) => (
                <div key={i}>
