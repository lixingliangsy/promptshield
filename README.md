...
> Scan your AI app for prompt-injection & jailbreak vulnerabilities before you ship.
>
> Describe your AI app and paste a sample of untrusted user input; get an injection-risk report with the exact patterns that fired and a hardening checklist. For LLM/agent product teams (devs + security) shipping customer-facing chatbots that accept untrusted input.
...
```bash
npm run build
# Vercel: import repo, set framework = Next.js, root = 12_Micro_SaaS出海/promptshield
```
